    ...
    <Slider {...settings}>
      <div className="slider-item" id='home'>
        ...
        <div className="slider-text">
          ...
          <h1 className='animate__animated animate__fadeInDown' >Nature your mind like a garden <br/> watch your self flourish</h1> <p className='animate__animated animate__backInLeft'>Join us as we plant seeds of resilience and grow <br />a garden of support and understanding</p>
